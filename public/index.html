...
<head>
    ...
    <link rel="icon" href="images/dragonboaticon.jpg">

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"
        integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <link rel="stylesheet" href="css/site.css">
    <title>Harvey Lake Dragon Boats</title>
</head>

<body>
    <!--nav bar-->
    <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
        <a class="navbar-brand" id="navbarTitle" href="#">Harvey Lake Dragon Boats</a>
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <p>To learn more about Harvey Lake Dragon Boats and the history of dragon boats click on the button
                        below.</p>
                    <p><a class="btn btn-info" href="about.html" role="button">View details &raquo;</a></p>
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <p>Look up our teams by their league or check them all out here! Click below to start
                        exploring! </p>
                    <p><a class="btn btn-info" href="search.html" role="button">View details &raquo;</a></p>
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <p><a class="btn btn-info" href="gallery.html" role="button">View details &raquo;</a></p>
                </div>
            </div>
        </div>
    </main>
